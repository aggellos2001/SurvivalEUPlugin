/*
 *  Copyright (c) 2019 Michail Angelos Tsiantakis All rights reserved.
 */
...
public class YamlConfig {
	 ...
	 * @param name             The name of the JavaUtils file excluding file extensions.
	 *                         <p>
	 *                         Please notice that the constructor does not yet create the YAML-configuration file. To create the file on the disk, use {@link}.
	 * @since 1.0.0
	 */
	...
	/**
	 * @since 1.0.0
	 * This creates the configuration file. If the data folder is invalid, it will be created along with the JavaUtils file.
	 */
	...
	/**
	 * @return The configuration file's directory. To get its name, use {@link } instead.
	 * @since 1.0.0
	 */
	 ...
	 * This returns the name of the configuration file with the .yml extension. To get the file's directory, use {@link}.
	 * @since 1.0.0
	 */
	...
	/**
	 * @return The JavaUtils file.
	 * This returns the actual File object of the JavaUtils file.
	 * @since 1.0.0
	 */
	public File getFile() {
		return YamlConfig;
	 ...
	 * This returns the actual FileConfiguration object of the JavaUtils file.
	 * @since 1.0.0
	 */
	...
	/**
	 * @param key   The JavaUtils key, including the path.
	 * @param value the JavaUtils value.
	 *              Set a default configuration value: if the entered key already exists (and it holds another value),
	 *              it will do nothing. If it doesn't, it will create the key with the wanted value.
	 * @since 1.0.0
	 */
	public String addDefault(String key, String value) {
	...
	public String addDefaultInt(String key, int value) {
		if (config.getString(key) == null) {
	...
	public String addDefaultBoolean(String key, boolean value) {
		if (config.getString(key) == null) {
	...
	public String addDefaultList(String key, List<String> value) {
		if (config.getString(key) == null) {
	...
	/**
	 * @since 1.0.0
	 * This reloads the configuration file, making Java acknowledge and load the new JavaUtils and its values.
	 */
	public void reload() {
		config = YamlConfiguration.loadConfiguration(YamlConfig);
	}
	...
	/**
	 * @since 1.0.0
	 * This deletes the JavaUtils file.
	 */
	...
	/**
	 * @since 2.0.0
	 * This deletes the JavaUtils file's directory and all it's contents.
	 */
	...
	/**
	 * @since 1.0.0
	 * Wipe the JavaUtils file's directory, including the file itself.
	 */
	 ...
	 *                     This will create a sub-directory in the plugin's data folder, which can be accessed with {@link}.
	 ...
	 * This returns true if the JavaUtils contains the given value.
	 * @since 1.0.0
	 */
