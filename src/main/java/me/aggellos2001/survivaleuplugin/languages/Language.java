...
public enum Language {
	...
	VOTE_REWARDS("&aYou got 500 claim blocks, 2 phantom membranes and 300$ for your vote!", "&aΠήρες 500 claim block, 2 phantom membrane και 300$ για το vote σου!"),
	...
	SHOP_SUCCESS_BUY("&aSuccessfully bought %sx %s for %s$!", "&aΑγόρασες επιτυχώς %sx %s για %s$"),
